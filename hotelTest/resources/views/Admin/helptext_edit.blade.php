				...
				<div class="main-content">
					...
					<div class="page-content">
							<div class="row">
								...
								<div class="col-xs-12">
									<form class="form-horizontal" method="post" action='Admin_helptextUpd' role="form" enctype="multipart/form-data">
									<div class="form-group" style="margin-top:30px;">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 咨询问题 </label>
										
										<div class="col-sm-9">
											<input type="text" name="help_title" id="form-field-1" placeholder="咨询问题" class="col-xs-10 col-sm-5" value="{{ $arr['help_title'] }}" /><span><?php echo $errors->first('help_title'); ?></span>
										</div>
									</div>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main no-padding">
													<div class="wysiwyg-editor" id="editor2" name='textarea'><?php echo $arr['help_content'];?></div>
												</div>
											</div>
										</div>
