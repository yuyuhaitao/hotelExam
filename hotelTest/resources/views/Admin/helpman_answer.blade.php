	...
	<!--引入顶部-->
			@include('admin.main')
				...
				<div class="main-content">
					...
					<button class="btn btn-lg btn-success" onclick="window.location.href='Admin_helpman'">
						<i class="icon-ok"></i>
						用户咨询列表
					</button>
					<div class="page-content">
							<div class="row">
								...
								<div class="col-xs-12">
									<form class="form-horizontal" method="post" action='Admin_helpmanHui' role="form" enctype="multipart/form-data">
									<div class="form-group" style="margin-top:30px;">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 提问人</label>
										
										<div class="col-sm-9">
											<font size="4">{{ $names['u_name'] }}</font>
										</div>
									</div>
									<div class="form-group" style="margin-top:30px;">
										...
										<div class="col-sm-9">
											<font size="4">{{ $arr['help_title'] }}</font>
										</div>
									</div>
									<input type="hidden" name="_token" value="{{ csrf_token() }}">
									<input type="hidden" name='help_content'>
									<input type="hidden" name='help_id' value="{{ $arr['help_id'] }}">
									<div class="form-group" style="margin-top:30px;">
