...
<a href="javascript:history.go(-1);" class="back">
    ...
    <span style="margin-left:15px"><a href="javascript:void(0)"><font size="3">我的历史问题</font></a></span>
    @foreach($arr as $k => $v)
      <h3><em></em>{{ $v['help_title'] }}<a href="Home_Qdel?help_id={{ $v['help_id'] }}" style="float:right">删除</a></h3>
      <div class="feng">
        @if($v['help_content'])
