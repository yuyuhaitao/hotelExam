...
<a href="javascript:history.go(-1);" class="back">
 ...
 <form class="form-horizontal" action="/Home_hotellist" method="GET" id="form1">
        ...
        .result {
            ...
            text-align: left;
				...
				<li>
                   ...
                   <div class="citybox">
                      @foreach($arr as $v)
                        <span cityId="{{$v['city_id']}}">{{$v['city_name']}}</span> 
                      @endforeach 
                   </div>
				</li>
			<li>
...
<script type="text/javascript">
    (function ($, undefined) {
        $(function () {//dom ready
            ...
            var beginday = '2016-06-11';
            var endday = '2016-06-12';
            //设置开始时间为今天
...
<script>
    ...
    //     var  city_id = $('#cityID').attr("cityId"));
    //     alert(city_id);
    // });
</script>
</html>
