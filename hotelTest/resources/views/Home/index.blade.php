...
<body>
 ...
 <div class="container">
 <div class="header">
 <img src="{{asset('Home/img/logo.png')}}" style="height: 40px; margin: 10px 0px 0px 15px" />
 </div>
  ...
  <div class="copyrights">Collect from <a href="http://www.cssmoban.com/" >免费模板</a></div>
    <div class="footer">
    <div class="gezifooter"> <a href="Home_city" class="ui-link">酒店预订</a> <font color="#878787">|</font> <a href="Home_Orderlist" class="ui-link">我的订单</a> <font color="#878787">|</font> <a href="Home_UserInfo" class="ui-link">我的格子</a> 
